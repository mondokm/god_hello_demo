...
*/
public final class EventSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public EventSeq (int initialMaximum) {
        super(Event.class, initialMaximum);
    }

    public EventSeq (Collection elements) {
        super(Event.class, elements);
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' Event objects (beyond the original size of this object)
