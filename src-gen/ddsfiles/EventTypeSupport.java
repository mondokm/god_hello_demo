...
public class EventTypeSupport extends TypeSupportImpl {
    ...
    */
        ...
        Object sample) 
    {
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(epd.getAlignment(currentAlignment), typedSrc.params );
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.params,255);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            try{
                ...
                typedDst.params = src.readString(255);
    ...
    int mask) {
        return new EventDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new EventDataReader(native_reader, listener, mask, this);   
